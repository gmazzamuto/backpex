defmodule Backpex.Adapter do
  ...
  """
  @callback get(primary_value :: term(), assigns :: map()) :: {:ok, struct() | nil} | {:error, term()}

  @doc """
  Returns a list of items by given criteria.
  """
  @callback list(criteria :: keyword(), assigns :: map()) :: {:ok, list()}
  ...
  """
  @callback count(criteria :: keyword(), assigns :: map()) :: {:ok, non_neg_integer()}

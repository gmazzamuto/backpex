if Code.ensure_loaded?(Ash) do
  defmodule Backpex.Adapters.Ash do
    ...
    def get(primary_value, %{live_resource: live_resource} = _assigns) do
    ...
    """
    @impl Backpex.Adapter
    def list(_criteria, %{live_resource: live_resource} = _assigns) do
    ...
    """
    @impl Backpex.Adapter
    def count(_criteria, %{live_resource: live_resource} = _assigns) do
      live_resource.adapter_config(:resource)
      |> Ash.count()
    end
